...
class TicketModelTestCase(TestCase):
    ...
    def test_ticket_type_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("ticketType").verbose_name
        )
        self.assertEqual(field_label, "ticketType")

    def test_subject_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("subject").verbose_name
        )
        self.assertEqual(field_label, "subject")

    def test_subject_max_length(self):
        max_length = (
            self.get_test_ticket()._meta.get_field("subject").max_length
        )
        self.assertEqual(max_length, 75)

    def test_project_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("project").verbose_name
        )
        self.assertEqual(field_label, "project")

    def test_description_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("description").verbose_name
        )
        self.assertEqual(field_label, "description")

    def test_description_max_length(self):
        max_length = (
            self.get_test_ticket()._meta.get_field("description").max_length
        )
        self.assertEqual(max_length, 1000)

    def test_priority_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("priority").verbose_name
        )
        self.assertEqual(field_label, "priority")

    def test_priority_max_length(self):
        max_length = (
            self.get_test_ticket()._meta.get_field("priority").max_length
        )
        self.assertEqual(max_length, 10)

    def test_status_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("status").verbose_name
        )
        self.assertEqual(field_label, "status")

    def test_status_max_length(self):
        max_length = (
            self.get_test_ticket()._meta.get_field("status").max_length
        )
        self.assertEqual(max_length, 40)

    def test_creator_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("creator").verbose_name
        )
        self.assertEqual(field_label, "creator")

    def test_owner_label(self):
        field_label = (
            self.get_test_ticket()._meta.get_field("owner").verbose_name
        )
        self.assertEqual(field_label, "owner")

    def test_shortened_subject_str(self):
        self.assertEqual(
            self.get_test_ticket().shortened_subject_str(),
    ...
    def test_get_absolute_url(self):
        self.assertEqual(
            self.get_test_ticket().get_absolute_url(), "/tickets/detail/1"
        )
...
class TicketTypeModelTestCase(TestCase):
    ...
    def test_ticket_type_label(self):
        field_label = (
            self.get_test_ticket_type()
            ._meta.get_field("ticketType")
            .verbose_name
        )
        self.assertEqual(field_label, "ticketType")
...
class ProjectModelTestCase(TestCase):
    ...
    def test_project_label(self):
        field_label = (
            self.get_test_project()._meta.get_field("project").verbose_name
        )
        self.assertEqual(field_label, "project")

    def test_project_max_length(self):
        max_length = (
            self.get_test_project()._meta.get_field("project").max_length
        )
